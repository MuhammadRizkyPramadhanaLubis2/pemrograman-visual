...
Partial Class FrmPerulangan
    ...
    Private Sub InitializeComponent()
        ...
        lblNilaiAwal.Location = New Point(262, 89)
        lblNilaiAwal.Name = "lblNilaiAwal"
        lblNilaiAwal.Size = New Size(88, 20)
        ...
        lblNilaiAkhir.Location = New Point(262, 134)
        ...
        ' txtNilaiAwal
        ' 
        txtNilaiAwal.Location = New Point(414, 88)
        ...
        ' txtNilaiAkhir
        ' 
        txtNilaiAkhir.Location = New Point(414, 134)
        ...
        ' btnInput
        ' 
        btnInput.Location = New Point(348, 213)
        ...
        lstHasil.Location = New Point(262, 277)
        lstHasil.Name = "lstHasil"
        lstHasil.Size = New Size(277, 104)
        lstHasil.TabIndex = 5
        ' 
        ' FrmPerulangan
        ' 
